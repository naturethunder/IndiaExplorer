/**
 * HARVEST FINAL 100 FRESH IMAGES
 */
...
const categories = [
  'Category:Hot springs of India',
  'Category:Glaciers of India',
...
function fetchJson(url) {
  return new Promise((resolve) => {
    ...
    try {
      req = https.get(url, {
        headers: {
          'User-Agent': 'IndiaExplorerBot/230.0 (contact@exploreindiahub.com)'
        }
      }, (res) => {
...
async function harvest() {
  console.log('=== HARVESTING FINAL 100 FRESH IMAGES ===\n');
  ...
  fs.writeFileSync('scripts/final_100_pool.json', JSON.stringify(pool, null, 2), 'utf8');
  console.log(`\n🎉 SAVED ${pool.length} FRESH IMAGES TO scripts/final_100_pool.json`);
}
