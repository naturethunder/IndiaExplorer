/**
 * ZERO-COLLISION PERFECTION CLOSER
 * - Uses 1,807 verified unused HD images from scripts/ultimate_pool.json.
...
const POOL_FILE = path.join(__dirname, 'ultimate_pool.json');
const TAJ_REGEX = /Taj_Mahal_in_March_2004/i;

function main() {
  console.log('=== ZERO-COLLISION PERFECTION CLOSER ===\n');
