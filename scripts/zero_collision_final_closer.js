/**
 * ZERO-COLLISION FINAL CLOSER
 * - Replaces remaining duplicate instances using final_push_pool.json.
 * - Synchronizes index.json.
 * - Runs mathematical verification audit.
 */
...
const POOL_FILE = path.join(__dirname, 'final_100_pool.json');
const TAJ_REGEX = /Taj_Mahal_in_March_2004/i;

function main() {
  console.log('=== ZERO-COLLISION FINAL CLOSER ===\n');
