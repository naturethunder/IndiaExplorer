/**
 * ZERO-COLLISION FINALIZER
 * - Uses 3,400+ verified unused HD images from scripts/final_fresh_3500.json.
...
const POOL_FILE = path.join(__dirname, 'final_fresh_3500.json');
const TAJ_REGEX = /Taj_Mahal_in_March_2004/i;

function main() {
  console.log('=== ZERO-COLLISION FINALIZER ===\n');
