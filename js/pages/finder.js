...
const SITE_INFO = [
  ...
  { keys: ['about exploredesh', 'about indiaexplore', 'about the site', 'about us', 'who made', 'who runs', 'who are you', 'your company', 'about you', 'the team'], icon: 'globe', title: 'About ExploreDesh', body: 'A guide to 2,393 destinations across all 36 states & UTs of India.', link: 'about.html', cta: 'About us' },
  ...
  { keys: ['how many destinations', 'how many places', 'total destinations', 'number of destinations', 'how many states'], icon: 'trending-up', title: '2,393 destinations', body: 'ExploreDesh covers 2,393 destinations across all 36 states & union territories.', link: 'destinations.html', cta: 'See all destinations' },
];
