...
function navbarHTML(active, variant) {
  ...
  const brand =
    ...
    '    </a>';
  const cta =
    '<a href="ai-finder.html" class="btn btn-primary text-sm px-4 py-2 rounded-full hidden md:inline-flex items-center gap-1.5 font-medium shrink-0 shadow-md hover:shadow-lg transition-all">\n' +
    '      ' + icon('sparkles', { size: 16 }) + ' Plan Trip\n' +
    '    </a>';
  return (
