...
function footerHTML() {
  ...
  return (
    ...
    '        </div>\n' +
    '        <p class="text-sm text-gray-400 leading-relaxed max-w-xs mb-3">India\'s most thoughtful travel discovery platform. Explore 2,393 verified destinations across 36 states and union territories.</p>\n' +
